...
{
    internal sealed class StreamingMultipartFormDataParser
    {
        #region Constants
        ...
        private void ParseFilePart(Dictionary<string, string> parameters, RebufferableBinaryReader reader)
        {
            ...
            var contentDisposition = parameters.ContainsKey("content-disposition")
            ...
            do
            {
                ...
                if (endPos != -1)
                {
                    ...
                    var boundaryNewlineOffset = CalculateNewlineLength(ref fullBuffer,
                    ...
                    var bufferNewlineOffset = FindNextNewline(
